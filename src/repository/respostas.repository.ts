...
export class RespostasRepository {
  async createResposta(formularioId: string, schemaVersion: number, respostas: any) {
  ...
  async softDeleteResposta(formularioId: string, respostaId: string, usuario: string) {
