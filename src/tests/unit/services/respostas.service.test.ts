...
import { FormularioNaoEncontradoError, PayloadInvalidoError } from '../../../errors/customErrors';
...
describe('RespostasService', () => {
  ...
  beforeEach(() => {
    ...
    formRepoMock = new FormulariosRepository() as jest.Mocked<FormulariosRepository>;
  ...
  it('deve lançar erro se formulário não existe', async () => {
    ...
    await expect(service.removerResposta('form1', 'resp1', 'user')).rejects.toThrow(
